...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run stage-F block0 evaluation.")
    parser.add_argument("--model-dir", default=DEFAULT_MODEL_DIR)
    parser.add_argument("--output-path", default=f"{DEFAULT_OUTPUT_DIR}/stage_f/block0_eval.json")
...
def main() -> None:
    ...
    print(f"Saved stage-F block0 report to {args.output_path}")
