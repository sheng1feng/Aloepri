...
from src.stage_g_artifact import save_stage_g_artifact


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export a full-layer stage-G obfuscated model artifact.")
    parser.add_argument("--model-dir", default=DEFAULT_MODEL_DIR)
    parser.add_argument("--artifact-dir", default="artifacts/stage_g_full_obfuscated")
    parser.add_argument("--seed", type=int, default=DEFAULT_SEED)
    parser.add_argument("--dtype", default="float32")
    parser.add_argument("--lambda", dest="lam", type=float, default=0.1)
    parser.add_argument("--h", type=int, default=32)
    parser.add_argument("--mode", choices=["norm_fused", "ffn_fused", "attention_fused"], default="attention_fused")
...
def main() -> None:
    ...
    print(f"Saved stage-G artifact to {args.artifact_dir}")
