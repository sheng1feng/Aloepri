...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export stage-H in a pretrained-like directory layout.")
    parser.add_argument("--model-dir", default=DEFAULT_MODEL_DIR)
    parser.add_argument("--export-dir", default="artifacts/stage_h_pretrained")
...
def main() -> None:
    ...
    print(f"Saved pretrained-like stage-H bundle to {args.export_dir}")
