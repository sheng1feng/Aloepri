...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run stage-B hidden-only experiment.")
    parser.add_argument("--model-dir", default=DEFAULT_MODEL_DIR)
    parser.add_argument("--output-path", default=f"{DEFAULT_OUTPUT_DIR}/stage_b/hidden_only.json")
...
def main() -> None:
    ...
    print(f"Saved stage-B hidden-only report to {args.output_path}")
