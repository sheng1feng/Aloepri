...
from src.stage_g_artifact import load_stage_g_artifact
from src.transforms import map_input_ids, restore_logits


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run greedy inference with a saved stage-G artifact.")
...
def main() -> None:
    args = parse_args()
    bundle = load_stage_g_artifact(args.artifact_dir)
