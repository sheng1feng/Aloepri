...
> 说明：本目录是 Qwen 安全证据与安全工作索引，不是 Qwen 部署主线入口。当前唯一主线入口见 [docs/论文一致最终部署主线.md](../../../论文一致最终部署主线.md)。

> 废弃说明：本目录中的 `Gate 2 / IMA` 最小 ridge baseline 材料仅保留历史参考价值，不再代表当前 Qwen 主线的 `IMA` 口径。当前活跃 `IMA` 结论只认 `paper_like` 结果。
...
14. `Gate6_增强点验证结果.md`
15. `Qwen安全总报告.md`
16. `部署线弱于StageH的原因分析.md`
17. `推进看板.md`
18. `部署线重构与当前安全简报.md`

补充阅读：

- `../../../AloePri 论文中的部署适配机制整理.md`
...
- `Qwen安全总报告.md`：当前安全结论、适用边界、完成度与下一步建议
- `部署线弱于StageH的原因分析.md`：为什么标准部署线会显著弱于研究线的根因分析
- `推进看板.md`：阶段状态、里程碑、待办
- `部署线重构与当前安全简报.md`：当前安全结论与论文主张的差异，以及本轮 Stage H-K 重构修到了哪、还差哪
